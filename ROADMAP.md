...
3. `[x]` Salt okunur public macOS API'leriyle gerçek CPU, bellek, disk, batarya doluluk/durumu ve ağ hızı
...
5. `[x]` i-Panel 1.3 (Build 4) imzasız public universal DMG, Gatekeeper kurulum notu, SHA-256 ve GitHub Release
